...
# flags.DEFINE_integer('replay_buffer_sample_size', 50000, '')
# flags.DEFINE_string('sw_dir', '', '')
# flags.DEFINE_string('env_name', 'CartPole-v0', '')
# flags.DEFINE_boolean('use_combined_loss', False, '')
# flags.DEFINE_float('actor_loss_weight', 1.0, '')
# flags.DEFINE_float('entropy_bonus', 0.01, '')
# FLAGS = flags.FLAGS
